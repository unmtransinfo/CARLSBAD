...
*/
public class Extract2CYJS_Task
	implements Callable<Boolean>
{
  ...
  public synchronized Boolean call()
  {
    try {
      ...
      this.counts=carlsbad_utils.Extract2CYJS(
	dbcon,
	fout,
	this.tids,
	this.cpd_id,
    ...
    catch (SQLException e)
    {
      ...
      System.err.println("ERROR: Extract2CYJS_Task SQLException "+this.errtxt);
      return false;
    }
    catch (IOException e)
    {
      this.errtxt=e.getMessage();
      System.err.println("ERROR: Extract2CYJS_Task IOException "+this.errtxt);
      return false;
    }
    catch (Exception e)
    {
      this.errtxt=e.getMessage();
      System.err.println("ERROR: Extract2CYJS_Task Exception "+this.errtxt);
      return false;
    }
    return true;
  }
  ...
  {
    private Extract2CYJS_Task task;
    public Status(Extract2CYJS_Task task) { this.task=task; }
